        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    ...
                    <p>We have the best electrical,plumbing and construction materials for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/aluminium pipe wretch.jpg" alt="aluminium pipe wretch">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> pipe wretch</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/hand tool.jpg" alt="hand tool">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>hand tool</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/plastic boring pipes.jpg" alt="plastic boring pipes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>plastic boring pipes</h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/1 hp motor.jpg" alt="1 hp motor">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>1 hp pumping motor</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/1.5 hp water motor.jpg" alt="1.5 hp water motor">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>1.5 hp pumping motor</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/crompton 0.5 hp motor.JPG" alt="crompton 0.5 hp motor">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Crompton 0.5 hp motor </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/texmo 7.5 hp motor.jpg" alt="texmo 7.5 hp motor">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>texmo 7.5 hp motor </h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wire cutters.jpg" alt="wire cutters">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>wire cutter set</h3>
                                    <p>Price: Rs. 300.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/tools package.jpg" alt="tools package">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>tool kit</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/8 in 1 screwdriver.jpg" alt="8 in 1 screwdriver">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>8 in 1 screwdriver</h3>
                                    <p>Price: Rs. 90.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/multimeter.jpg" alt="multimeter">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Multimeter</h3>
            ...
            <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/insulation tapes.jpg" alt="insulation tapes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>insulation tapes</h3>
                                    <p>Price: Rs. 80.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
            ...
            <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wire bundle.jpg" alt="wire bundle">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>wire bundle</h3>
            ...
            <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/led bulb.jpg" alt="led bulb">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>led bulb</h3>
            ...
            <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/socket button.jpg" alt="socket button">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Button and socket</h3>
                                    <p>Price: Rs. 10.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
            ...
            <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/construction set.jpg" alt="construction set">
                            </a>
                            <center>
                                <div class="caption">
            ...
            <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/angle grinder.jpg" alt="angle grinder">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Angle grinder</h3>
            ...
            <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/generator.jpg" alt="tile leveling">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Generator</h3>
